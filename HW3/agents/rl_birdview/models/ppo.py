...
class PPO():
    ...
    def learn(self, total_timesteps, callback=None, seed=2021, ckpt_path_and_run_path = None):
        # reset env seed
        ...
        while self.num_timesteps < total_timesteps:
            ...
            if count == 9:
                evaluated = True
                if evaluated:
                    with open(ckpt_path_and_run_path[0], 'w') as fi:
                        fi.write(ckpt_path_and_run_path[1])                
